...
const KPPlanetSignificator = ({ data }) => {
    console.log("KPPlanetSignificator Data ::: ", data);
    ...
    return (
        <table className="min-w-full border-collapse border border-gray-200 text-left">
            ...
            <tbody>
                {data?.planetSignificators?.map((value, index) => (
                    <tr key={index} className="odd:bg-white even:bg-gray-50">
                        <td className="border border-gray-200 px-4 py-2 text-orange-600">{value?.planet}</td>
...
export default KPPlanetSignificator;