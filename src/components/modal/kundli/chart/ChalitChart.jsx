...
const ChalitChart = ({ data }) => {
    console.log("ChalitChart Data ::: ", data?.chart);
                            ...
                            return (
                                <g key={rashiIndex} className="sign">
                                    ...
                                    {planets?.map((planet, i) => (
                                        // <text key={i} x={textPosition.x} y={textPosition.y + (i + 1) * 10} textAnchor="middle" fontSize="8" fill={planet?.color}>
                                        //     {planet?.name}
                                        // </text>
