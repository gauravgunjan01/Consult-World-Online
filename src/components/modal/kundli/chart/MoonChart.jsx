...
const MoonChart = ({ data }) => {
    console.log("MoonChart Data ::: ", data?.chart);
                            ...
                            return (
                                <g key={rashiIndex} className="sign">
                                    ...
                                    {planets?.map((planet, i) => (
                                        <text key={i} x={textPosition.x + (i * 13) - 20} y={textPosition.y - 12} textAnchor="middle" fontSize="8" fill={planet?.color}>     {planet?.name} </text>
                                    ))}
                                </g>
                            );
                        })}
